...
<p>
   <img src='img/tennis_serve.gif' width=95 />
   <img src='img/tennis_forehand.gif' width=95 />
   <img src='img/pull_up.gif' width=95 />
   <img src='img/jumping_jacks.gif' width=95 />
   <img src='img/golf_swing.gif' width=95 />
   <img src='img/clean_and_jerk.gif' width=95 />
   <img src='img/baseball_swing.gif' width=95 />
   <img src='img/baseball_pitch.gif' width=95 />
   <img src='img/squats.gif' width=95 />
</p>
